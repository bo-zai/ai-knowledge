...
async function main() {
  const dbPath = process.argv[2] || 'D:/workspace/other_project/joyrpc/.knowledge/lbug';

  const candidates = [
    { filePath: 'joyrpc-core/src/main/java/io/joyrpc/Result.java', className: 'Result' },
    { filePath: 'joyrpc-spring/src/main/java/io/joyrpc/spring/ServerBean.java', className: 'ServerBean' },
  ];
