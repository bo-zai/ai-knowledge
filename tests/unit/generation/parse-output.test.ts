...
import { parseGeneratorOutput, parseTypedOutput } from '../../../src/generation/parse-output';
...
`;
  ...
  it('extracts JSON from partial text', () => {
    const partialText = 'Some prefix text {"objects":[{"id":"DB-users"}],"warnings":[]} some suffix text';
