      ...
      contributions: [
        {
          stage: "db",
          files: [
            { path: "objects/db/DB-users.yaml", content: "id: DB-users\n" },
          ],
          objects: [
            { id: "DB-users", type: "DB", path: "objects/db/DB-users.yaml" },
          ],
          report: {
            stage: "db",
            ran: true,
        ...
        },
        {
          ...
          files: [
            {
              path: "objects/capabilities/CAP-ORDER.yaml",
              content: "id: CAP-ORDER\n",
            },
          ],
          objects: [
            {
