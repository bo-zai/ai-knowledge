...
describe("assembleCapabilityKnowledgeObjects", () => {
  ...
  const claims: CandidateClaim[] = [
    {
      suggestedType: "CAP",
      claimText:
        "DB knowledge generation capability transforms MyBatis evidence into DB knowledge objects",
      confidence: "high",
      evidenceRefs: [
      ...
      decisionPoints: [
        "Which fields to include in DB object",
        "How to infer descriptions",
      ],
    ...
    },
    {
      suggestedType: "MOD",
      claimText:
        "MyBatis evidence module handles mapper parsing and SQL extraction",
      confidence: "high",
    ...
    },
    {
      suggestedType: "CON",
      claimText:
        "DB object schema contract defines the structure of generated DB knowledge objects",
      confidence: "high",
    ...
    },
    {
      suggestedType: "VER",
      claimText:
        "Test validation anchor confirms DB object generation produces valid output",
      confidence: "high",
  ...
  it("creates MOD-MYBATIS-EVIDENCE", () => {
    const objects = assembleCapabilityKnowledgeObjects({ bundle, claims });
    const mod = objects.find(
      (o) => o.id.includes("MYBATIS") && o.type === "MOD",
    );
      ...
      claims: [
        {
          suggestedType: "TERM",
          claimText:
            "goods is a business term evidenced within Goods Order capability.",
          confidence: "medium",
