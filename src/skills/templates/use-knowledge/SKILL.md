...
检索和引用 `ai-knowledge/` 知识库，获得仓库上下文。

**核心原则**：知识库的第一个入口是 `index.md`，不要直接跳到某个知识文件。
...
modules.json 记录仓库内各模块的路径、角色、依赖关系和入口：
- 理解仓库的模块组织方式
...
| `_glossary.md` | 术语速查表 | 需要快速确认术语含义时 |
